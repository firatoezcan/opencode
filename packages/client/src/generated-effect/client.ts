...
type Endpoint1_1Request = Parameters<RawClient["server.location"]["location.reload"]>[0]
...
const Endpoint1_1 = (raw: RawClient["server.location"]) => (input?: Endpoint1_1Input) =>
  raw["location.reload"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup1 = (raw: RawClient["server.location"]) => ({ get: Endpoint1_0(raw), reload: Endpoint1_1(raw) })
...
type Endpoint3_4Request = Parameters<RawClient["server.session"]["session.setTitle"]>[0]
...
const Endpoint3_4 = (raw: RawClient["server.session"]) => (input: Endpoint3_4Input) =>
  raw["session.setTitle"]({ params: { sessionID: input["sessionID"] }, payload: { title: input["title"] } }).pipe(
    Effect.mapError(mapClientError),
  )
...
type Endpoint3_8Request = Parameters<RawClient["server.session"]["session.resume"]>[0]
...
type Endpoint11_0Request = Parameters<RawClient["server.review"]["review.diff"]>[0]
type Endpoint11_0Input = {
  readonly location?: Endpoint11_0Request["query"]["location"]
  readonly context?: Endpoint11_0Request["query"]["context"]
}
const Endpoint11_0 = (raw: RawClient["server.review"]) => (input?: Endpoint11_0Input) =>
  raw["review.diff"]({ query: { location: input?.["location"], context: input?.["context"] } }).pipe(
    Effect.mapError(mapClientError),
  )

const adaptGroup11 = (raw: RawClient["server.review"]) => ({ diff: Endpoint11_0(raw) })
...
const adaptClient = (raw: RawClient) => ({
  ...
  reviews: adaptGroup11(raw["server.review"]),
